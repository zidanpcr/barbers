export default function TailwindCSS(){
    return (
        <div>
            <h1 class="bg-emerald-500 text-white px-4 py-2 mx-4 rounded shadow-lg">Belajar Tailwind CSS 4</h1>
            <button className="bg-amber-500 text-white px-4 py-2 mx-4 rounded shadow-lg">Click Me</button>
            <Spacing/> 
            <Typography/>   
            <BorderRadius/>      
            <BackgroundColors/>  
